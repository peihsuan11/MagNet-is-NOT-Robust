...
class Evaluator:
    ...
    def plot_various_confidences(self, graph_name, drop_rate,
        ...
        for confidence in confs:
            ...
            #f="EAD-Attack-1/e-3/L1train"+str(confidence)+"_0.001.npy"
            f="EAD-Attack-EN/e-3/ENtrain"+str(confidence)+"_0.001.npy"
            #f="nn_robust_attacks/ID/L2train"+str(confidence)+".npy"
        ...
        plt.xlabel(r"Confidence in EAD $EN$ attack ($beta= 10^{-3} $)")
        #plt.xlabel(r"Confidence in EAD $L^1$ attack ($beta= 10^{-3}$)")
        ...
        #save_path = os.path.join(self.graph_dir, graph_name+"_EADL1_e-3_JSD.pdf")
        save_path = os.path.join(self.graph_dir, graph_name+"_EADEN_e-3_JSD.pdf")
